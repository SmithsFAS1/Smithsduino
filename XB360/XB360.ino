...
//Comment flag for Keyboard Emulation mode
//#define TESTMODE
...
#include <Update.h>
#include "OTA.h"
const char* host = "IR_ESP32"; //host name on the network, change if desired
...
void setup() {
  ...
  while (!Serial); //wait for Serial connection in test mode, comment out to just keep going at startup
